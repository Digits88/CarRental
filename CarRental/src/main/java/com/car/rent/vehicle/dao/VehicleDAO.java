...
public interface VehicleDAO extends JpaRepository<Vehicle, Integer> {
	...
	void setVehicleByVehicleId(String brand, String type, String vehiclePlateNumber, int model,
			int numberOfSeats, double dailyPrice, Boolean isAvailable, int vehicleId);
}
